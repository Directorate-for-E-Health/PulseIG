...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/ExtDeviceCode']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/ExtDeviceCode': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/MeasurementSettingExt']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/MeasurementSettingExt': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/ExtPerformer']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/ExtPerformer': maximum cardinality of 'extension' is 1</sch:assert>
